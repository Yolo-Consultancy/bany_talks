      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto overflow-hidden">
          ...
          <div className="text-left select-none overflow-hidden">
            <span className="inline-block text-[10px] font-mono tracking-wider text-amber-500 uppercase font-medium bg-amber-500/10 px-1.5 py-0.5 rounded mb-0.5">
        ...
        <div className="flex flex-col items-center gap-1.5 w-full md:flex-1 max-w-md">
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="w-11 h-11 flex items-center justify-center rounded-full bg-amber-500 text-stone-950 hover:scale-105 hover:bg-amber-400 active:scale-95 transition cursor-pointer shadow-lg shadow-amber-500/20"
            >
          ...
          <div className="flex items-center gap-3 w-full select-none">
            ...
            >
              ...
              <div className="h-1.5 w-full bg-stone-800 rounded-full group-hover:h-2 transition-all duration-200">
                ...
                >
                  {/* Thumb handle */}
                  <div className="absolute right-0 top-1/2 -translate-y-1/2 w-3.5 h-3.5 bg-amber-400 rounded-full border border-stone-900 group-hover:scale-125 opacity-0 group-hover:opacity-100 transition duration-150 shadow-md shadow-black/80" />
                </div>
              </div>
              ...
              {hoverTime !== null && hoverX !== null && (
                <div 
                  className="absolute bottom-6 bg-amber-500 text-stone-950 px-2.5 py-1 rounded text-[10px] font-mono font-bold tracking-wider -translate-x-1/2 pointer-events-none shadow-2xl border border-amber-400 z-50 transition-all duration-75"
        ...
        <div className="flex items-center gap-4 w-full md:w-auto justify-end">
          ...
          <button 
            ...
            className="flex items-center gap-0.5 px-3 py-1 bg-stone-800 hover:bg-stone-700 text-xs text-amber-500 rounded-lg transition font-mono font-bold cursor-pointer"
          >
          ...
          <div className="flex items-center gap-2 group">
            ...
            <input
              ...
              title="Volume"
              className="w-16 md:w-20 accent-amber-500 h-1 rounded-lg bg-stone-700 cursor-pointer"
            />
          </div>
      ...
      {isExpanded && (
        <div className="mt-4 pt-3 border-t border-stone-800/80 grid grid-cols-1 md:grid-cols-2 gap-4 text-left animate-fade-in-up">
          <div className="bg-stone-950/40 p-3 rounded-lg border border-stone-800/50">
            <span className="text-[10px] font-mono tracking-wider text-amber-500 block uppercase mb-1">Citation Épisode</span>
          ...
          <div>
            <span className="text-[10px] font-mono tracking-wider text-amber-500 block uppercase mb-1">Segments Clés</span>
            <div className="max-h-24 overflow-y-auto space-y-1.5 custom-scrollbar">
              {activeEpisode.timestamps.slice(0, 3).map((item, idx) => (
                <div key={idx} className="flex gap-2 items-start text-xs text-stone-400 hover:text-stone-100 transition">
                  <span className="text-amber-500 font-mono text-[11px] shrink-0 font-bold">{item.time}</span>
